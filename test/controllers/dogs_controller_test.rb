...
class DogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dog" do
    assert_difference('Dog.count') do
      post dogs_url, params: { dog: { image_url: @dog.image_url, name: @dog.name, user_id: @dog.user_id } }, as: :json
    end
  ...
  test "should update dog" do
    patch dog_url(@dog), params: { dog: { image_url: @dog.image_url, name: @dog.name, user_id: @dog.user_id } }, as: :json
    assert_response 200
  end
